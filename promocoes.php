...
// Configurações do banco de dados (as mesmas usadas em outros arquivos)
...
// Consulta para buscar apenas os produtos que estão em promoção
// Usamos a mesma estrutura de dados da tabela 'produto'
...
<head>
    ...
    <title>Promoções - Serrone Burger</title>
    ...
    <style>
        ...
        .promo-image { height: 200px; overflow: hidden; }
        .promo-image img { width: 100%; height: 100%; object-fit: cover; }
        .promo-info { padding: 15px; text-align: left; }
        .promo-info h3 { font-size: 1.5em; margin-bottom: 5px; color: #d9534f; }
        .promo-info p { font-size: 1em; color: #5a3c2c; line-height: 1.4; }
        .promo-price { font-weight: bold; color: #f0ad4e; font-size: 1.2em; margin-top: 10px; }
        ...
        <div class="promo-list">
            ...
            if ($result_promocoes->num_rows > 0) {
                while($row = $result_promocoes->fetch_assoc()) {
                    ...
                    // Se uma imagem foi encontrada, exibe o card da promoção
                    if ($image_src) {
                    ?>
                    <div class="promo-card">
                        ...
                        <div class="promo-info">
                            ...
                            <p class="promo-price">R$ <?php echo number_format($row['valor_produto'], 2, ',', '.'); ?></p>
                        </div>
                    </div>
                    <?php
                    }
                ...
                echo "<p class='content'>Nenhuma promoção ativa no momento. Volte em breve!</p>";
            }
            ?>
        </div>
    </div>
